...
public class SyncActivityJobService extends Worker {

    private boolean jobCancelled = false;

    SyncActivityClass syncActivityClass = new SyncActivityClass(getApplicationContext(),1);

    public SyncActivityJobService(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        try {
            ...
            jobCancelled=syncActivityClass.jobCancelled;
        } catch(Throwable e) {
