...
public class SyncAppUsageStatJobService extends Worker {

    private static final String TAG = SyncAppUsageStatJobService.class.getName();
    private boolean jobCancelled = false;

    SyncAppUsageStatClass syncAppUsageStatClass = new SyncAppUsageStatClass(getApplicationContext(),1);


    public SyncAppUsageStatJobService(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        try {
            ...
            jobCancelled=syncAppUsageStatClass.jobCancelled;
        } catch(Throwable e) {
