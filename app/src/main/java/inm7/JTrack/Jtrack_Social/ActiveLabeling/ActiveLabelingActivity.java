...
//    private ImageView imageViewReset;
   ...
   VoiceRecord voiceRecord = new VoiceRecord(this);
    ...
    private void startStop() {
        if (timerStatus == TimerStatus.STOPPED ) {
            if (timeCountInMilliSeconds!=0){
                ...
                if (PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getInt("ActiveLabeling_switch",0)==2)
                {
                ...
                if (record_voice_label){
                    if (CheckPermissions() ){
                        voiceRecord_name= studyId+"_"+username+"_"+deviceid+"_"+start_timestamp;
...
//            imageViewReset.setVisibility(View.GONE);
            ...
            // stop services if manual mode is enabled for active labeling
...
//                imageViewReset.setVisibility(View.GONE);
    ...
    private void showAddItemDialog(Context c) {
        ...
        final String[] activityAutoList = {"Normal Gang","Rückwärts Gehen","Enger Stand","Tandem Stand","Tandem Gang","Stand mit geschlossenen Augen","Einbeinstand","180 Derhung"};
        ArrayAdapter<String> adapter = new ArrayAdapter<String>
                (this, android.R.layout.select_dialog_item, activityAutoList);
        ...
        dialogBuilder.setPositiveButton("hinzufügen", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (task_duration.getText().toString().trim().isEmpty()){
                    task_duration_label=35; // default value TODO to constatnts
                ...
                }else if ( task_duration_label==35 ) {
    ...
    private void RequestPermissions() {
        ActivityCompat.requestPermissions(ActiveLabelingActivity.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
