...
public final class Constants {
    ...
    public final static String applicationType = "Social";
    ...
    public final static String transformLatO = "transformLatO";
    public final static String transformLonO = "transformLonO";
    ...
    public final static Integer patchSize = 2*(60*50); // 2 min of data in 50 Hz.
