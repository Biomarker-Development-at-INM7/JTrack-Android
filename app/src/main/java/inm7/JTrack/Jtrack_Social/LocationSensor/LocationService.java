...
//        }
    ...
    public void onLocationChanged(Location location) {
        ...
        // if old one use previous method,TODO delete this latter *** time to date !
        if (transformationValue.getLong("patient_Time_Joined",System.currentTimeMillis()) < System.currentTimeMillis() ){
            myGPSlocation = rotateGPSAroundPoint(location.getLatitude(),location.getLongitude(),location.getLatitude(), transformationValue.getInt(Constants.transformationid,360) );
...
*/
    ...
    public LocationSensor rotateGPSAroundPoint(double lat, double lon, double h, double degree)
    {
        ...
        double latO = Double.parseDouble(sharedPref.getString (Constants.transformLatO,"0.0"))  ;  // lat range in -90 to 90
        double lonO = Double.parseDouble(sharedPref.getString (Constants.transformLonO,"0.0") ) ; // long range is -180 to 180
